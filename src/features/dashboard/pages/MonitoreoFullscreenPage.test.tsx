...
describe('MonitoreoFullscreenPage', () => {
  ...
  it('muestra el banner de observación de la línea entre el header y los KPIs', () => {
    vi.mocked(useMonitoreoLineas).mockReturnValue({
      ...baseHookResult,
      lineas: [{ id: 1, nombre: 'Linea Fullscreen', activo: true, rutaAsignadaAt: null, rutaPasadaActiva: { id: 10, nombre: 'Ruta Fullscreen' }, dispositivo: { id: '5' }, observacion: 'Cuidado con el sensor de peso' }],
      lineaActual: { id: 1, nombre: 'Linea Fullscreen', activo: true, rutaAsignadaAt: null, rutaPasadaActiva: { id: 10, nombre: 'Ruta Fullscreen' }, dispositivo: { id: '5' }, observacion: 'Cuidado con el sensor de peso' },
      resumen: { conectado: false, pasadaEnCurso: null, tiempoDesdeRuta: null },
      kpis: { muestrasTotales: 0, fueraRango: 0, pasadasFinalizadas: 0, pasadasEnCurso: 0 },
    });
