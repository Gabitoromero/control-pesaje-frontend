...
describe('DashboardLayout — visibilidad del menú por rol', () => {
  ...
  it('jefe ve los principales, parametrización y administración; los sub-items admin-only se ocultan', async () => {
  ...
  it('Parametrización se auto-expande si la ruta coincide con un sub-item, sin afectar a Administración', () => {
  ...
  it('Administración se auto-expande si la ruta coincide con un sub-item, sin afectar a Parametrización', () => {
